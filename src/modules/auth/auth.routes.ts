...
import { activateInviteSchema, loginSchema, refreshSchema, registerSchema } from './auth.schema';
...
authRouter.get('/activate-invite', controller.activateInvitePage);
authRouter.post('/activate-invite', validate(activateInviteSchema), controller.activateInvite);
